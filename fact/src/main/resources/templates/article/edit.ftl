...
<div class="layui-fluid">
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" readonly="readonly" value="${article.images}"  name="images" required  lay-verify="required" placeholder="封面图片" autocomplete="off" class="layui-input" style="width: calc(100% - 61px); display: inline-block;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="cate" lay-verify="required">
                    ...
                    <#list cate as c>
                    <option ${(article.cate==c.id)?string('selected' , '')} value="${c.id}">${c.name}</option>
                    </#list>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea name="description" placeholder="请输入简介" class="layui-textarea">${article.description}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
